...
const Footer = () => {
  return (
    <>
      <footer class='bg-seconary  bg-gray-100 text-white'>
        <div className='container'>
              ...
              <div class=''>
                ...
                <p class='flex justify-center md:justify-start my-2 text-base '>
                  <IconContext.Provider
                    value={{
                      size: '1.2em',
                      className: 'mt-[1.2px] mr-3 self-start'
                    }}
                  >
                    <div>
                      <BsMailbox2 />
                ...
                <div class=''>
                  <p class='flex items-center justify-center md:justify-start my-2 text-base'>
                    <IconContext.Provider
          ...
          <div class='text-center p-6 bg-gray-200 border-t border-gray-300'>
            <span>© 2022 Copyright Superpasses | Website by </span>
            <a
              class='text-white font-semibold'
              target='blank'
              href='https://beezkneez.nz/'
            >
              Beezkneez
            </a>
          </div>
